...
GUARDED_ENTRYPOINTS = (
    ...
    "scripts/diagnostics/capture_boss_side_by_side.py",
...
FIXED_INPUTS = (
    ...
    ".gitignore",
    "CLAUDE.md",
    "docs/audit/ted_candidate_baseline_v4.json",
    "docs/audit/boss_silhouette_contracts.json",
    "docs/audit/ted_baseline_v4/determinism.json",
    "docs/audit/ted_baseline_v4/readiness.json",
    "pyproject.toml",
    ...
    "scripts/build_ted_expanded_candidate.py",
